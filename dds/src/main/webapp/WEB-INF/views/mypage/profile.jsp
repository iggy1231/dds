	                    ...
	                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
	                        <div class="property-item rounded overflow-hidden">
	                            ...
	                            <a href=""><img class="ratio ratio-4x3 img-fluid" src="https://ppss.kr/wp-content/uploads/2023/02/1-2.jpeg" alt=""></a>
	                                ...
	                                <div class="display-9 bg-white rounded-top text-primary position-absolute start-0 bottom-0 mx-4 pt-1 px-3"><h5 style="font-weight: 600;">순천</h5></div>
	                            </div>
	                            <div class="px-4 py-2 pb-3">
	                                <a class="d-block h4 mb-2 mt-2" href="" style="font-size:18px; font-weight: 600;">순천만 정원박람회 갔다온 후기 푼다.</a>
	                                <h6 class="display-10" style="color: #666565;"><i class="text-primary bi bi-chat-fill"></i>&nbsp;&nbsp;3개</h6> 
	                                <h6 class="display-10 py-1" style="color: #666565;"><i class="bi bi-calendar-check"></i>&nbsp;2024-08-07</h6>
	                            </div>
	                        </div>
	                    </div>
					</div>
        	...
        	<div id="tab-pane-2" class="tab-pane fade p-0">
                        <div class="mt-1 p-2 list-question">
                            <div class="mt-1 border-bottom">
                                <a class="p-1 fw-semibold fs-4" href="">순천 정말 좋은곳이네요. 다음에 한 번 가볼게요</a>
                                <h6 class="p-1 fs-5 text-secondary"><i class="bi bi-airplane"></i>&nbsp; 두둥실 여행후기 </h6>
                                <div class="row p-2 fs-5">
					                <div class="col text-end pt-2 px-0">
					                    <span class="text-secondary">2024-07-12</span>&nbsp;|&nbsp;<span class="deleteQuestion" data-num="1">삭제</span>
					                </div>
            					</div>
                            </div> 
                        </div>
