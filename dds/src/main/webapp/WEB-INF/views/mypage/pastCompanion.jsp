...
<c:forEach var="list3" items="${list}">
	...
	<div class="content-card" onclick="companionArticle(${list3.num});">
		<div class="d-flex align-items-stretch" style="height: 230px;">
			<img class="ratio ratio-4x3" src="${pageContext.request.contextPath}/uploads/companion/${list3.saveFilename}" alt="Content Image" style="object-fit:cover; height: 100%;">
		</div>
		<div class="card-body">
			<h4 class="bold">${list3.subject}</h4>
			<span class="text-primary age-gender">#${list3.age}대&nbsp;&nbsp;#${list3.gender}</span> 
			<div class="meta mt-2">
