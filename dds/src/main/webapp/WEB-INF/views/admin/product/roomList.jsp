		...
		<tbody class="table-border-bottom-0">
			<c:forEach var="dto" items="${list}" varStatus="status">
				<tr class="text-center">
					...
					<td>${dto.reg_date}</td>
					<td><c:url var="updateUrl" value="/admin/product/update">
...
<div class="col-auto pt-4 ps-4 text-start">${dataCount}개(${page}/${total_page}
	페이지)</div>
				...
				<div class="col-auto p-1">
					<div class="input-group">
						<input type="text" name="kwd" id="searchKeyword" value="${kwd}"
							class="form-control"
							onkeypress="if(event.keyCode==13) { event.preventDefault(); document.getElementById('btnSearch').focus(); }">
						<button id="btnSearch" type="button"
							class="btn btn-primary btn-search" data-gubun="room">
