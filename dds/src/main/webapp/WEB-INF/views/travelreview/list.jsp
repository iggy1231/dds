...
<% String noimage="/resources/images/noimage.png";%>
<!DOCTYPE html>
<html lang="ko">
<head>
<meta charset="UTF-8">
...
<body>
	<div class="container">
		...
		<div id="content-items">
			<div
				style="margin-left: 60px; font-size: 30px; color: #18A8F1">전
				세계 여행 후기</div>
			<c:forEach var="dto" items="${list}">
				<div class="post" onclick="article(${dto.num});">
					<div class="post-header">
						<div class="profile">
							<img
								src="https://imagecache.tripsoda.com?url=https://tripsoda.s3.ap-northeast-2.amazonaws.com/prod/1648436737226&width=40&height=40"
								alt="profile picture">
							<div class="info">
								<div>
					...
					<div class="post-content row justify-content-between">
						...
						<img class="col" 
							...
							onerror=this.src="${pageContext.request.contextPath}<%=noimage%>"></img>
					</div>
					<hr>
					<div class="post-footer justify-content-around">
						...
						<div class="action">
							<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
								...
								<path fill-rule="evenodd" clip-rule="evenodd"
									d="M9.11586 4C5.73818 4 3.00004 6.5132 3.00004 9.61339V13.8235L3 21.1429L8.59096 17.5657H15.7413C19.119 17.5657 21.8571 15.0525 21.8571 11.9523V9.61339C21.8571 6.5132 19.119 4 15.7413 4H9.11586Z"
						...
						<div class="action">
							<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
								viewBox="0 0 24 24" fill="none">
								<path fill-rule="evenodd" clip-rule="evenodd"
									d="M4.19169 5.62781C1.9361 7.86203 1.9361 11.4844 4.19169 13.7186L12.1816 21.6329C12.197 21.6481 12.213 21.6625 12.2294 21.676C12.4961 21.9398 12.9282 21.9397 13.1948 21.6757L21.1817 13.7644C23.4373 11.5302 23.4373 7.90777 21.1817 5.67356C18.9262 3.43934 15.2691 3.43934 13.0135 5.67355L12.7098 5.97443L12.3599 5.62781C10.1043 3.39359 6.44727 3.39359 4.19169 5.62781Z"
									fill="#9A9A9A"></path></svg>
	...
	$('#selectAreabtn button').click(function(){
		let region=$(this).val();
		
		let query = `&page=${page}&schType=${schType}&kwd=${kwd}`;
        location.href = "${pageContext.request.contextPath}/travelreview/listHas?region="+region+query;
	});
