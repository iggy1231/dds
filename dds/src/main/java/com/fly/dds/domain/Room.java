...
public class Room {
    ...
    private MultipartFile detailPhotoFile;
    private MultipartFile thumbnailFile;
     
    private String thumbnail;
    
    // Getter와 Setter 메서드
    public MultipartFile getDetailPhotoFile() {
        return detailPhotoFile;
    }
    public void setDetailPhotoFile(MultipartFile detailPhotoFile) {
        this.detailPhotoFile = detailPhotoFile;
    }
